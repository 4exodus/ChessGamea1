      ...
      <div className="space-y-6">
              ...
              >
                ...
                <div className="mt-2 space-y-1">
                  ...
                  <div className="flex items-center gap-1 text-sm">
                    ...
                    <span>{match.players.white} vs {match.players.black}</span>
                  </div>
                </div>
              </button>
            ))}
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          ...
          <div className="prose prose-invert">
            <p className="text-gray-300 mb-4">{selectedMatch.historicalContext}</p>
            <p className="text-gray-300 mb-4">{selectedMatch.culturalSignificance}</p>
            <h4 className="text-amber-500 mt-4 mb-2">Players</h4>
            <p className="text-gray-300 mb-2">
              <strong className="text-amber-500">White:</strong> {selectedMatch.playerBackgrounds.white}
            </p>
            <p className="text-gray-300">
              <strong className="text-amber-500">Black:</strong> {selectedMatch.playerBackgrounds.black}
            </p>
